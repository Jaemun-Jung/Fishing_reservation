...
##############################################################
$감시목록 = @(
    # ===== 2026-07-17 예약완료(마감) 배 감시 (취소자리 나면 알림) =====
    # 선상24 → 클라우드 24시간 감시
    @{ 배 = "뉴항구호";   날짜 = @("2026-07-17") }
    @{ 배 = "팀에프원";   날짜 = @("2026-07-17") }
    # thefishing → 내 PC(시작하기.bat) 감시
    ...
    @{ 배 = "보스호";     날짜 = @("2026-07-17") }
    @{ 배 = "루나호";     날짜 = @("2026-07-17") }
    @{ 배 = "영복1호";    날짜 = @("2026-07-17") }
    @{ 배 = "항공모함";   날짜 = @("2026-07-17") }
    @{ 배 = "블레스호";   날짜 = @("2026-07-17") }
    @{ 배 = "퀸블레스호"; 날짜 = @("2026-07-17") }
    @{ 배 = "아일랜드호"; 날짜 = @("2026-07-17") }
    @{ 배 = "블루오션호"; 날짜 = @("2026-07-17") }
)
